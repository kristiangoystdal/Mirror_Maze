...
public class TileMap : MonoBehaviour
{
    ...
    // Place a tile at a given world position
    public void PlaceTile(Tilemap tilemap, Vector3 worldPosition, TileBase tile)
    {
        Vector3Int cellPosition = tilemap.WorldToCell(worldPosition);
        tilemap.SetTile(cellPosition, tile);
    }

    // Remove a tile at a given world position
    public void RemoveTile(Tilemap tilemap, Vector3 worldPosition)
    {
        Vector3Int cellPosition = tilemap.WorldToCell(worldPosition);
